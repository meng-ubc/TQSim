...
public:
	 ...
	 */
	NoiseTreeSimulator(const QuantumCircuit *init_circuit, const double prob1, const double prob2, const std::vector<int> shots_given, const std::vector<int> lengths, const QuantumState *init_state = NULL);
